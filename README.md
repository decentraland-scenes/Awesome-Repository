...
| [Power Cube](https://github.com/decentraland-scenes/power-cube)             | <img src="screenshots/power-cube.gif" width="200">              | Using simple planes to create a forcefield effect that blocks the player from reaching the access card.                                   |
