...
| [Pixel Mural](https://github.com/decentraland-scenes/mural-example-scene)        |                                                     | Create 2D pixel art by painting tiles. Players are synced through both the messagebus and a DB in a server.                           |
...
| [Genesis Plaza](https://github.com/decentraland-scenes/Genesis-Plaza)                   |                                              | The full code used in Genesis Plaza (0,0), including all the interactive elements found there.                                                                                       |
| [Soho Plaza](https://github.com/decentraland-scenes/Soho-Plaza)                         |                                              | The full code used in Soho Plaza (-75,0), including all the interactive elements found there.                                                                                        |
