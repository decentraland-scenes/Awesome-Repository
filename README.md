...
| [Translocator](https://github.com/decentraland-scenes/translocator)                       | <img src="screenshots/translocator.gif" width="200">            | Combining the new spawn feature with physics to create a translocator disc, which allows a player to teleport to wherever the disc is located.                                            |
